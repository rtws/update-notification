...
function Extension()
{
	...
	{
		chrome.tabs.create({
			url: chrome.extension.getURL("pages/updated.html?" + localStorage.lastInstalledVersion + "," + this.updateManager.installedVersion)
		});
	}
...
Extension.prototype.checkUpdate = function()
{
	...
	this.updateManager.isUpdateAvailable(function(installedVersion, availableVersion)
	{
		if (availableVersion !== localStorage.lastAvailableVersion && availableVersion !== installedVersion)
		{
			...
			chrome.browserAction.setIcon({
				path: {
					"19": "images/toolbar-highlight-19.png",
					"38": "images/toolbar-highlight-38.png"
				}
	        });
...
Extension.prototype.getSettings = function(callback)
{
	var self = this;
